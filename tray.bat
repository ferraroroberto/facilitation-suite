...
chcp 65001 >nul
REM ============================================================================
REM  facilitation-suite TRAY - tray icon that owns a long-lived service lifecycle
REM ----------------------------------------------------------------------------
...
REM
REM  Idempotent:
REM    tray.bat              -> no-op if a facilitation-suite tray is already running
...
REM  the 8449 reclaim list -- reclaiming one would kill the sibling.
REM
...
set "TRAY_APP_NAME=facilitation-suite"
...
REM === ADAPT (4/4): replace 8449 with this tray's exclusively-owned
REM     ports as a comma list, e.g. 8445,8446 . Exclude any mutex-shared port. ===
set "OWNED_PORTS=8449"
